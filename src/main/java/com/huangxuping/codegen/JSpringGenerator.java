...
public class JSpringGenerator extends AbstractJavaCodegen implements BeanValidationFeatures, PerformBeanValidationFeatures,
        OptionalFeatures  {
  private static final Logger LOGGER = LoggerFactory.getLogger(JSpringGenerator.class);
  ...
  public JSpringGenerator() {
    super();
    outputFolder = "generated-code/javaSpring";
    apiTestTemplateFiles.clear(); // TODO: add test template
    embeddedTemplateDir = templateDir = "j-spring";
  ...
  private void loadPropertiesFromConfig() {
    // JASON
    additionalProperties.put("skipApiComment", false);
    additionalProperties.put("skipComment", false);
...
//              (sourceFolder + File.separator + apiPackage).replace(".", java.io.File.separator), "ApiUtil.java"));
      ...
      for (final CodegenOperation operation : ops) {
        ...
        if (responses != null) {
          for (final CodegenResponse resp : responses) {
            ...
            doDataTypeAssignment(resp.dataType, new JSpringGenerator.DataTypeAssigner() {
              @Override
        ...
        doDataTypeAssignment(operation.returnType, new JSpringGenerator.DataTypeAssigner() {
   ...
   */
  private void doDataTypeAssignment(String returnType, JSpringGenerator.DataTypeAssigner dataTypeAssigner) {
